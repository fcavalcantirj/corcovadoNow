...
while true; do 
	...
	if [[ $HOUR -ge 10 && $HOUR -le 21 ]]; then
		...
		scp -o StrictHostKeyChecking=no -i /home/pi/fcavalcanti.pem /home/pi/corcovadoStream/outputs/$DATETIME.jpg ec2-user@52.26.112.248:/usr/local/nginx/html/imgs/last.jpg
		wait
	else
