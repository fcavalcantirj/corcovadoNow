...
while true; do 
	...
	if [[ $HOUR -ge 10 && $HOUR -le 21 ]]; then
		...
		scp -i /home/pi/fcavalcanti.pem /home/pi/corcovadoStream/outputs/$DATETIME.jpg ec2-user@ec2-52-26-112-248.us-west-2.compute.amazonaws.com:/usr/local/nginx/html/imgs/last.jpg
		wait
	else
